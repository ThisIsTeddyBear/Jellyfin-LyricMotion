...
Every archive contains the generated platform `README.md`, `VERSION`, runtime assets from `src/`, and the required license/notice files. The remaining contents are platform-specific:
...
6. Inject only the main LyricMotion CSS/JS immediately before Jellyfin's runtime bundle.
