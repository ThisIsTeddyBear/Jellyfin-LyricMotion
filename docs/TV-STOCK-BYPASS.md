...
PlayStation/Xbox and generic Smart-TV identifiers. A high-confidence
remote-only pointer fallback also catches embedded ten-foot WebViews whose user
agent omits a useful TV brand/model marker.
